"""
BM25 Baseline search engine for FPPC opinions.

Uses BM25Okapi over the qa_text field (question + conclusion) with a simple
tokenization pipeline. No stemming, no field boosting — just a clean keyword
baseline to establish a performance floor.
"""
...
_INDEX_PATH = os.path.join(_PROJECT_ROOT, "indexes", "BM25Baseline_index.pkl")
...
class BM25Baseline(SearchEngine):
    """BM25Okapi baseline over qa_text (question + conclusion) fields."""
